        ...
        <g id="Mainsail" transform="matrix(1,0,0,1,10,0)">
            <g id="Mainsail_text" transform="matrix(1,0,0,1,-54.2745,6.1424)">
                <text
                    x="47.429px"
                    y="60.749px"
                    :style="'font-family:BerkeleyMono;font-size:16px;fill:rgb(' + colorMainsail + ');'">
                    Mainsail
                </text>
            </g>
        ...
        <g id="Moonraker" transform="matrix(1,0,0,1,10,0)">
            <g id="Moonraker_text" transform="matrix(1,0,0,1,120.368,6.1424)">
                <text
                    x="45.429px"
                    y="60.749px"
                    :style="'fill:rgb(' + colorMoonraker + ');font-family:BerkeleyMono;font-size:16px;'">
                    Moonraker
                </text>
            </g>
        ...
        <g id="Klipper" transform="matrix(1,0,0,1,10,0)">
            <g id="Klipper_text" transform="matrix(1,0,0,1,317.036,6.1424)">
                <text
                    x="48.429px"
                    y="60.749px"
                    :style="'font-family:BerkeleyMono;font-size:16px;fill:rgb(' + colorKlipper + ');'">
                    Klipper
                </text>
            </g>
